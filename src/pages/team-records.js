/*
 * NOTES *
  - https://www.rydercup.com/news-media/all-time-usa-ryder-cup-team-records
*/
...
const PlayerRecordsPage = ({ location }) => {
  ...
  const siteTitle = title || `BFBH Cup`

  return (
    <Layout location={location} title={siteTitle}>
      <SEO title="Team Records" />
      <LandingPageHeader title="Team Records" />
