    ...
    <>
      ...
      <div className="row pt-5">
        <div className="col-12 col-md-6">
          <h3 className="h4">2025 Cup Foreword</h3>
          {/* <p>
            ...
            becoming very permanent), Cam and Travis are sitting out this year,
            and, brother-in-law, Blake (HC 16) is filling in on Blue.
          </p> */}
