  ...
  return (
    <>
      <div className="mb-3">
        ...
        <p>
          In perhaps the match of the weekend, RJ and Evan found themselves down
          4 points with 5 holes to play against Gordon and Derek. In an absolute
        ...
        <p>
          ...
          hole besides #9 was scored. An exciting match that ended in
          All-Square.
        </p>
        <p>
          ...
          and Curtis winning 5 straight holes against Evan and Dan. After day 1,
          Green lead 8.5-3.5.
        </p>
        <h2>Day 2</h2>
        <p>
        ...
        <p>
          ...
          18. It was the putt heard across the course. Craig missing a 3 foot
          putt that ended the match in AS and gave Green the 1/2 point needed to
          seal the victory.
        </p>
        <p>
